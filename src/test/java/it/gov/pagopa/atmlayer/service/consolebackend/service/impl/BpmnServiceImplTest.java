...
class BpmnServiceImplTest {
    ...
    void addSingleAssociationTest() {
        ...
        Uni<BpmnBankConfigDTO> result = bpmnService.addSingleAssociation(uuid, 1L, bankConfigTripletDto, containerRequestContext);
        assertNotNull(result);
        assertNull(result.await().indefinitely());
    }
    ...
    void deleteSingleAssociationTest() {
        ...
        Uni<Void> result = bpmnService.deleteSingleAssociation(uuid, 1L, "acquirerId", "branchId", "terminalId", containerRequestContext);
        assertNotNull(result);
        assertNull(result.await().indefinitely());
    }
    ...
    void replaceSingleAssociationTest() {
        ...
        Uni<BpmnBankConfigDTO> result = bpmnService.replaceSingleAssociation(uuid, 1L, bankConfigTripletDto,containerRequestContext);
    ...
    void deployBPMNTest() {
        ...
        Uni<BpmnDTO> result = bpmnService.deployBPMN(uuid, 1L, containerRequestContext);
    ...
    void disableBPMNTest() {
        ...
        Uni<Void> result = bpmnService.disableBPMN(uuid, 1L, containerRequestContext);
    ...
    void upgradeBPMNTest() {
        ...
        Uni<BpmnDTO> result = bpmnService.upgradeBPMN(bpmnUpgradeDto, containerRequestContext);
