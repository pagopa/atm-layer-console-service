...
class ResourceResourceTest {
    ...
    void testCreateResource() {
        ...
        when(userService.checkAuthorizationUser(any(), any())).thenReturn(Uni.createFrom().voidItem());
        when(resourceService.createResource(any(ResourceCreationDto.class), any(ContainerRequestContext.class)))
                .thenReturn(Uni.createFrom().item(response));
    ...
    void testUpdateResource() {
        ...
        when(userService.checkAuthorizationUser(any(), any())).thenReturn(Uni.createFrom().voidItem());
        when(resourceService.updateResource(any(File.class), any(UUID.class), any(ContainerRequestContext.class)))
                .thenReturn(Uni.createFrom().item(response));
    ...
    void testDisableResource() {
        ...
        when(userService.checkAuthorizationUser(any(), any())).thenReturn(Uni.createFrom().voidItem());
        when(resourceService.disable(any(UUID.class), any(ContainerRequestContext.class)))
